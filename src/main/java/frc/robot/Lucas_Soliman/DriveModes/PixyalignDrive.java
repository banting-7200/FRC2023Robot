...
public class PixyalignDrive implements DriveMode{
    ...
    private XboxController inputDevice;

    public PixyalignDrive(RobotDrive baseInstance, XboxController driveStick) {
    ...
    public void DriveModePeriodic() {
        ...
        double fwdInput = inputDevice.getRightY();
        boolean creepEnabled = inputDevice.getLeftTriggerAxis() > 0.5;
